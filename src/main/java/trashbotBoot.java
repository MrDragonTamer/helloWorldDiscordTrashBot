...
public class trashbotBoot {
    ...
    private static instantHumorEquals humorEquals = new instantHumorEquals("data" + fileSep + "instantHumorEqualsPhrases.dat");
    private static instantHumorContains humorContains = new instantHumorContains("data" + fileSep + "instantHumorContainsPhrases.dat");
    private static EmojiReactions emojiReactions = new EmojiReactions("data" + fileSep + "emojisReactionData.dat");
    private static KaraokeBot karaokeBot = new KaraokeBot("data" + fileSep + "lyrics.dat", permissions);
